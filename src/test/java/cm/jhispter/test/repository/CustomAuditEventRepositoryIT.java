package cm.jhispter.test.repository;

import cm.jhispter.test.JHipsterTestApp;

import cm.jhispter.test.config.Constants;
import cm.jhispter.test.config.audit.AuditEventConverter;
import cm.jhispter.test.domain.PersistentAuditEvent;
...
import static cm.jhispter.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
