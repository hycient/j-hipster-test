package cm.jhispter.test.web.rest;

import cm.jhispter.test.JHipsterTestApp;
import cm.jhispter.test.config.Constants;
import cm.jhispter.test.domain.User;
import cm.jhispter.test.repository.AuthorityRepository;
import cm.jhispter.test.repository.UserRepository;
import cm.jhispter.test.security.AuthoritiesConstants;
import cm.jhispter.test.service.UserService;
import cm.jhispter.test.service.dto.PasswordChangeDTO;
import cm.jhispter.test.service.dto.UserDTO;
import cm.jhispter.test.web.rest.vm.KeyAndPasswordVM;
import cm.jhispter.test.web.rest.vm.ManagedUserVM;
...
import static cm.jhispter.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
